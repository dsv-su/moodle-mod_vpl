...
#@vpl_script_description Using g++ C++23 ISO standard with math and util libs
...
# Compile
g++ -std=c++23 -pedantic -fno-diagnostics-color -o vpl_execution $2 @.vpl_source_files -lm -lutil
rm .vpl_source_files
apply_run_mode
